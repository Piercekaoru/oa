...
const allowValue = process.env.OPENACHIEVE_ALLOW_LOCKFILE_CHANGE;
...
if (allowed) {
	console.error("package-lock.json is staged; OPENACHIEVE_ALLOW_LOCKFILE_CHANGE is set, allowing commit.");
	process.exit(0);
}
...
console.error("  OPENACHIEVE_ALLOW_LOCKFILE_CHANGE=1 git commit ...");
process.exit(1);
