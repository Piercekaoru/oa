...
export class TUI extends Container {
	...
	private showHardwareCursor = process.env.OPENACHIEVE_HARDWARE_CURSOR === "1";
	private clearOnShrink = process.env.OPENACHIEVE_CLEAR_ON_SHRINK === "1"; // Clear empty rows when content shrinks (default: off)
