...
import type { AssistantMessage, Model } from "@openachieve/ai";
...
vi.mock("@openachieve/ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@openachieve/ai")>();
	return {
		...actual,
