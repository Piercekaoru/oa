...
export interface ExtensionUIContext {
	...
	/** Request an immediate TUI redraw when interactive UI is active. */
	 ...
	 * extend `CustomEditor` from `@openachieve/agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@openachieve/agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown Openachieve Agent and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what Openachieve Agent loaded without re-discovering resources. */
