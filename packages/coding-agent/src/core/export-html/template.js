    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="oa-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="openachieve-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'openachieve-share:v1:sidebar-width';
