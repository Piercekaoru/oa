...
Settings locations:
- User scope: `~/.openachieve/agent/settings.json`
- Project scope: `.openachieve/settings.json`
...
- `~/.openachieve/agent/agents/**/*.md` — user scope
- `.openachieve/agents/**/*.md` — canonical project scope
- legacy `.agents/**/*.md` — still read for compatibility, but `.openachieve/agents/` wins on conflicts

Chains live in:
- `~/.openachieve/agent/chains/**/*.chain.md` and `~/.openachieve/agent/chains/**/*.chain.json` — user scope
- `.openachieve/chains/**/*.chain.md` and `.openachieve/chains/**/*.chain.json` — project scope
...
`oa-subagents` works without `pi-intercom`. When `pi-intercom` is installed and enabled, the intercom bridge can automatically give child agents a private coordination channel back to the parent session.
...
`oa-subagents`. This is useful when a slash command should always run through a
