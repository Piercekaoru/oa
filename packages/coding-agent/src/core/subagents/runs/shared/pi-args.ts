...
export const SUBAGENT_RUN_ID_ENV = "OPENACHIEVE_SUBAGENT_RUN_ID";
export const SUBAGENT_CHILD_AGENT_ENV = "OPENACHIEVE_SUBAGENT_CHILD_AGENT";
export const SUBAGENT_CHILD_INDEX_ENV = "OPENACHIEVE_SUBAGENT_CHILD_INDEX";
export const SUBAGENT_FANOUT_CHILD_ENV = "OPENACHIEVE_SUBAGENT_FANOUT_CHILD";
export const SUBAGENT_PARENT_EVENT_SINK_ENV = "OPENACHIEVE_SUBAGENT_PARENT_EVENT_SINK";
export const SUBAGENT_PARENT_CONTROL_INBOX_ENV = "OPENACHIEVE_SUBAGENT_PARENT_CONTROL_INBOX";
export const SUBAGENT_PARENT_ROOT_RUN_ID_ENV = "OPENACHIEVE_SUBAGENT_PARENT_ROOT_RUN_ID";
export const SUBAGENT_PARENT_RUN_ID_ENV = "OPENACHIEVE_SUBAGENT_PARENT_RUN_ID";
export const SUBAGENT_PARENT_CHILD_INDEX_ENV = "OPENACHIEVE_SUBAGENT_PARENT_CHILD_INDEX";
export const SUBAGENT_PARENT_DEPTH_ENV = "OPENACHIEVE_SUBAGENT_PARENT_DEPTH";
...
export function buildPiArgs(input: BuildPiArgsInput): BuildPiArgsResult {
	...
	env[SUBAGENT_PARENT_CAPABILITY_TOKEN_ENV] = fanoutAuthorized
		...
		: "";
	env.OPENACHIEVE_SUBAGENT_INHERIT_PROJECT_CONTEXT = input.inheritProjectContext ? "1" : "0";
	env.OPENACHIEVE_SUBAGENT_INHERIT_SKILLS = input.inheritSkills ? "1" : "0";
	if (input.intercomSessionName) {
		env.OPENACHIEVE_SUBAGENT_INTERCOM_SESSION_NAME = input.intercomSessionName;
	}
