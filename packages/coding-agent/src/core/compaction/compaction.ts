...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@openachieve/agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@openachieve/ai";
import { completeSimple } from "@openachieve/ai";
import {
	convertToLlm,
