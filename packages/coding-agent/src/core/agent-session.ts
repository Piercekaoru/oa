...
import type { Agent, AgentEvent, AgentMessage, AgentState, AgentTool, ThinkingLevel } from "@openachieve/agent-core";
import type { AssistantMessage, ImageContent, Message, Model, TextContent } from "@openachieve/ai";
import {
	clampThinkingLevel,
...
export class AgentSession {
	...
	async prompt(text: string, options?: PromptOptions): Promise<void> {
		...
		try {
			...
			// Extension commands manage their own LLM interaction via api.sendMessage()
