...
Openachieve Agent runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
# Install Openachieve Agent
npm install -g --ignore-scripts @openachieve/agent

# Create config directory
mkdir -p ~/.openachieve/agent

# Run Openachieve Agent
Openachieve Agent
```
...
Create `~/.openachieve/agent/AGENTS.md` to help the agent understand the Termux environment:
