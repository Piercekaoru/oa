> Openachieve Agent can create prompt templates. Ask it to build one for your workflow.
...
Openachieve Agent loads prompt templates from:

- Global: `~/.openachieve/agent/prompts/*.md`
- Project: `.openachieve/prompts/*.md`
