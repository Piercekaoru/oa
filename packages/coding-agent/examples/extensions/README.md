...
Example extensions for Openachieve Agent.

## Usage

```bash
# Load an extension with --extension flag
oa --extension examples/extensions/permission-gate.ts

# Or copy to extensions directory for auto-discovery
cp permission-gate.ts ~/.openachieve/agent/extensions/
```
...
| Extension | Description |
|-----------|-------------|
| `mac-system-theme.ts` | Syncs Openachieve Agent theme with macOS dark/light mode |
...
| `custom-provider-gitlab-duo/` | GitLab Duo provider using @openachieve/ai's built-in Anthropic/OpenAI streaming via proxy |
